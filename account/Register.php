...
<span class="caption-subject bold uppercase basecolor">Registretion Form</span>
</div>
...
$res = $db->query("INSERT INTO users SET firstname='".$firstname."', lastname='".$lastname."', dob='".$dob."', location='".$location."', gender='".$gender."', mobile='".$mobile."', email='".$email."', password='".$passmd."', mv='".$regst[1]."', mvcode='".$mvcode."', ev='".$regst[2]."', evcode='".$evcode."'");
...
<input name="firstname" class="form-control input-lg" placeholder="First Name" type="text" required=""> 
</div>
</div>
...
<input name="lastname" class="form-control input-lg" placeholder="Last Name" type="text" required=""> 
</div>
</div>
...
<input class="form-control form-control-inline input-lg date-picker" data-date-format="dd-mm-yyyy" name="dob"  type="text" placeholder="dd-mm-yyyy" required="">
</div>
</div>
...
<input class="form-control input-lg" name="mobile"  type="text" placeholder="Mobile Number With Country Code" required="">
</div>
</div>
...
<br><br>
<div class="col-md-12">
<h4 class="block">Your Email:</h4>
<div class="input-group">
<span class="input-group-addon">
<i class="fa fa-envelope fa-2x"></i>
</span>
<input name="email" id="email" class="form-control input-lg" placeholder="Email Address" type="email" required=""> 
</div>
</div>
...
<input name="password2" id="confirmPassword" class="form-control input-lg" type="password">
</div>
