...
<li>
<a href="<?php echo $baseurl; ?>/API">
<i class="fa fa-cogs" style="color: #<?php echo $basecolor; ?>;"></i> API Management </a>
</li>
                ...
                <div class="container">
                     <div class="hor-menu  ">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="<?php echo $baseurl; ?>/SendMoney"> Send Money</a></li>
                            <li><a href="<?php echo $baseurl; ?>/RequestMoney"> Request Money</a></li>
                            <li><a href="<?php echo $baseurl; ?>/AddMoney"> Add Money</a></li>
                            <li><a href="<?php echo $baseurl; ?>/WithdrawMoney"> Withdraw Money</a></li>
