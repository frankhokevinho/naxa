...
$subtitle = "Welcome Back to $basetitle";
?>
</head>
...
$ddaa = $db->query("SELECT id, byy, amount, sig, typ, charge, tm, trxid, msg, byy, refund FROM trx WHERE who='".$uid."' ORDER BY id DESC LIMIT 0,12");
...
<div class="col-xs-12">
<?php echo "$paytxt $byy[0] $byy[1]"; ?>
<span class="pull-right"><?php echo number_format($data[2], $baseDecimal); ?> <?php echo $basecurrency; ?></span>  <br>

</div>
<div class="col-xs-12">
Fee  <span class="pull-right"><?php echo number_format($data[5], $baseDecimal); ?> <?php echo $basecurrency; ?></span>  <br> </div>
<div class="col-xs-12">
<p><b>TOTAL <span class="pull-right"><?php echo $amo; ?> <?php echo $basecurrency; ?></span>  </b><br></p>
</div>
