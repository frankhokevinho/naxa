...
$ddaa = $db->query("SELECT id, tm, method, track, amount, charge, amountus, bcam, bcid, bcconfirm, trx, trx_ext, status FROM deposit_data WHERE usid='".$uid."' AND status='1' ORDER BY id DESC LIMIT ".$start.",".$itemPerPage."");
