...
<br><br><input type="text" class="form-control input-lg"  name="num" value="<?php echo $num[0]; ?>" placeholder="Your Email" disabled=""><br>
<button type="submit" class="btn btn-primary btn-block btn-lg">SEND CODE TO ABOVE EMAIL</button><br>
</form>
</div>
</div>
</div>
