...
$res =  $db->query("UPDATE users SET firstname='".$firstname."', lastname='".$lastname."', mobile='".$mobile."', dob='".$dob."',  gender='".$gender."',  location='".$location."',  pkg='".$pkg."', api='".$api."',  block='".$block."',  ev='".$ev."',  mv='".$mv."' WHERE id='".$id."'");
...
<!-- START -->
<a href="<?php echo "$adminurl/UsersDeposit/$id"; ?>">
<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="margin-bottom: 20px;">
...
<div class="desc uppercase bold text-center"> 
<?php echo $basecur; ?> 
<span data-counter="counterup" data-value="<?php echo round($amountdeposit[0] , $baseDecimal); ?>"><?php echo round($amountdeposit[0] , $baseDecimal); ?></span> DEPOSITED
</div>
</div>
</div>
</div>
...
<div class="col-md-6">
<div class="form-group">
<label class="col-md-12"><strong>packege</strong></label>
<div class="col-md-12">

<select name="pkg" class="form-control input-lg">
<?php 
$curr = $db->query("SELECT id, name FROM packs WHERE id='".$data['pkg']."'")->fetch();
echo "<option value='$curr[0]' selected=''>$curr[1] -- Selected</option>";

$ddaa = $db->query("SELECT id, name FROM packs");
while ($pack = $ddaa->fetch()) {
echo "<option value='$pack[0]'>$pack[1]</option>";
}
?>
...
<div class="col-md-6">
<div class="form-group">
<label class="col-md-12"><strong>Api Key</strong></label>
<div class="col-md-12">
<input class="form-control input-lg" name="api" value="<?php echo $data['api']; ?>" type="text">
</div>
</div>
</div>
