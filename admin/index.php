...
<input name="username" class="form-control input-lg" placeholder="Username" type="text" value="">
</div>

<div class="form-group">
<input name="password" class="form-control input-lg" placeholder="Password" type="password" value="">
</div>
