...
$db->query("INSERT INTO trx SET who='".$id."', byy='000900', amount='".$amount."', sig='+', typ='Added By Staff', charge='0', tm='".$tm."', trxid='".$trx."', msg='".$message."', refund='8'");
////##################### ADD MONEY
///////////////////add to generated 
...
if($res){
notification("Updated Successfully!", "", "success", false, "btn-success", "OKAY");
$db->query("INSERT INTO trx SET who='".$id."', byy='000900', amount='".$amount."', sig='-', typ='Substructed By Staff', charge='0', tm='".$tm."', trxid='".$trx."', msg='".$message."', refund='8'");
