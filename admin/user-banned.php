...
//----------->>>>> PAGE
$itemPerPage = 15;
$ttl = $db->query("SELECT COUNT(*) FROM users WHERE block='1'")->fetch();
...
$ddaa = $db->query("SELECT id, firstname, lastname, mobile, email, mallu FROM users WHERE block='1' ORDER BY id ASC LIMIT ".$start.",".$itemPerPage."");
$boxtext = "BANNED USERS LIST";
...
$prevnum=$page-1;
$prev ="<li> <a href=\"$adminurl/BannedUsers/$prevnum\"> &lt;&lt;</a> </li>";
if($page<="1"){
...
echo "<li><a href=\"$adminurl/BannedUsers/$pSt\"> $pSt</a> </li> ";
}

$pSt++;
}
$nextnum=$page+1;
$next ="<li> <a href=\"$adminurl/BannedUsers/$nextnum\">&gt;&gt;</a> </li> ";
if($page>=$tpg){
