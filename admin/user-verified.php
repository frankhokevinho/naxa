...
//----------->>>>> PAGE
$itemPerPage = 15;
$ttl = $db->query("SELECT COUNT(*) FROM users WHERE ev='1' AND mv='1'")->fetch();
...
$ddaa = $db->query("SELECT id, firstname, lastname, mobile, email, mallu FROM users WHERE ev='1' AND mv='1' ORDER BY id ASC LIMIT ".$start.",".$itemPerPage."");
$boxtext = "VERIFIED USERS LIST";
...
$prevnum=$page-1;
$prev ="<li> <a href=\"$adminurl/VerifiedUsers/$prevnum\"> &lt;&lt;</a> </li>";
if($page<="1"){
...
echo "<li><a href=\"$adminurl/VerifiedUsers/$pSt\"> $pSt</a> </li> ";
}

$pSt++;
}
$nextnum=$page+1;
$next ="<li> <a href=\"$adminurl/VerifiedUsers/$nextnum\">&gt;&gt;</a> </li> ";
if($page>=$tpg){
