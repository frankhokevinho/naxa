...
//----------->>>>> PAGE
$itemPerPage = 15;
$ttl = $db->query("SELECT COUNT(*) FROM users WHERE ev='0'")->fetch();
...
$ddaa = $db->query("SELECT id, firstname, lastname, mobile, email, mallu FROM users WHERE ev='0' ORDER BY id ASC LIMIT ".$start.",".$itemPerPage."");
$boxtext = "EMAIL UNVERIFIED USERS LIST";
...
$prevnum=$page-1;
$prev ="<li> <a href=\"$adminurl/EmailUnverifiedUsers/$prevnum\"> &lt;&lt;</a> </li>";
if($page<="1"){
...
echo "<li><a href=\"$adminurl/EmailUnverifiedUsers/$pSt\"> $pSt</a> </li> ";
}

$pSt++;
}
$nextnum=$page+1;
$next ="<li> <a href=\"$adminurl/EmailUnverifiedUsers/$nextnum\">&gt;&gt;</a> </li> ";
if($page>=$tpg){
