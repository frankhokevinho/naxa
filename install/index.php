...
$fronturl = "'.$base_url.'"; //////Main Page URL
$baseurl = "'.$base_url.'/account"; ////// Member Panel URL
$adminurl = "'.$base_url.'/admin"; ////// Admin Panel URL
$apiurl = "'.$base_url.'/paynow"; ////// API URL
$verifyurl = "'.$base_url.'/verify"; ////// Verify URL
$PurchaseCode = "'.$code.'";
